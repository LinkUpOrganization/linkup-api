...
public class GetUserInfoQueryHandler(IUserService userService, ICurrentUserService currentUserService)
    : IRequestHandler<GetUserInfoQuery, Result<UserProfileDto>>
{
        ...
        CancellationToken ct)
    {
        ...
        var userResult = await userService.GetUserInformationAsync(request.UserId, currentUserId);
